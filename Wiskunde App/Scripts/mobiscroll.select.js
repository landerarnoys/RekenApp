    ...
    $.mobiscroll.presets.select = function (inst) {
        ...
        function setVal(v, fill, change) {
            ...
            if (multiple) {
                ...
                try {
                    var klasnummer = parseInt(inst.values[0]) + 1;
                    $('div.dialer > div.col-xs-12.col-sm-12.col-md-12.col-lg-12 > div.input-group > input').val(klasnummer + inst.values[1]);
                } catch (e) {
                    console.log("Init bitch");
                }
